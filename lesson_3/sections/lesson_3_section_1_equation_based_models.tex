...
Start from the SIS equation for the infected compartment:
  ...
  \]
  \pause
Since $S + I = 1$ (normalised population), substitute $S = 1 - I$:
  \[
...
\begin{frame}{SIS Model: Equilibria and Stability}
\small
...
\begin{frame}{SIS Model: Phase Portrait}
  \begin{center}
    \includegraphics[width=1\textwidth]{images/sis_stability.pdf}
  \end{center}
  \small
...
\begin{frame}{SIR Dynamics: Effect of $R_0$}
  \begin{center}
    \includegraphics[width=\textwidth]{images/sir_r0_comparison.pdf}
  \end{center}
  \small
