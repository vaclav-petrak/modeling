...
\usepackage{styles/project_style2026} 
\addbibresource{references/projects.bib}

% --- TITLE PAGE INFORMATION ---
\title{Introduction to the Agent-Based Models}
...
The following code demonstrates an agent-based implementation of the SI (Susceptible–Infected) model in Python. Unlike the equation-based approach shown in the sample, this spatial agent-based model tracks individual agents moving in a two-dimensional space, providing a more granular view of disease spread dynamics.
