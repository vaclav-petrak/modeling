...
John von Neumann (1903–1957): Hungarian-American polymath  made pioneering contributions across multiple scientific disciplines. 
    \begin{columns}
    \column{0.2\textwidth}
            \includegraphics[width=\textwidth]{images/von_neumann.jpg} 
...
\begin{frame}{Applications of Cellular Automata}
    ...
    \only<1>{
        ...
        \vfill
        \begin{center}
            \includegraphics[width=\textwidth]{images/ca_fluid.png}
        \end{center}
    }
    \only<2>{
       \textbf{Epidemic Models:} Cellular automata help simulate the spread of diseases by modeling individuals as cells and defining rules for infection transmission and recovery.
        \vfill
        \begin{center}
            \includegraphics[scale=0.3]{images/ca_epidemics.jpeg}
        \end{center}
    }
    \only<3>{
        ...
        \vfill
        \begin{center}
            \includegraphics[scale=0.12]{images/ca_tumor.png}
            \includegraphics[scale=0.4]{images/ca_tumor_2.jpg}
        \end{center}
    }
    \only<4>{
       ...
       \vfill
       \begin{center}
           \includegraphics[scale=0.25]{images/ca_art.jpg}
       \end{center}
    }
    \only<5>{
       \textbf{Art and design:} Cellular automata were also used for visual effect in Noita game
        \vfill
        \begin{center}
            \includegraphics[scale=0.3]{images/ca_noita.jpg}
        \end{center}
    }
    \only<6>{
        ...
        \vfill
        \begin{center}
            \includegraphics[scale=0.2]{images/ca_fire.png}
        \end{center}
    }
    \only<7>{
       \textbf{Simulations of Social Movements:} These models use cellular automata to represent social dynamics and group behaviors, aiding in the study of phenomena like crowd movements and protests.
        \vfill
        \begin{center}
            \includegraphics[scale=0.6]{images/ca_crowd.png}
        \end{center}
    }
\end{frame}
