...
There is no exam. Your grade will be based on your independent work. There are four outputs used for grading.

\begin{enumerate}
    \item \textbf{Journal Club Presentation}: 20\% of the final grade
    \item \textbf{Capstone Project Presentation}: 30\% of the final grade
    \item \textbf{Poster Presentation}: 30\% of the final grade
    \item \textbf{Code Review Discussion}: 20\% of the final grade
\end{enumerate}
...
\begin{itemize}
    ...
    \item Output of your work will be a presentation, a poster, and code.
    \item The presentation dates will be arranged individually.
\end{itemize}
